...
router.post('/candidato/anexos/:id/delete', authCandidato, ensureCandidato, candidatoArquivoController.deletarAnexo);
router.get('/public/candidato/anexos/:id/abrir', candidatoArquivoController.abrirAnexoPublico);
